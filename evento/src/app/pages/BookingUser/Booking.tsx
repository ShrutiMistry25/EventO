...
import { getVenues, timeSlots } from '../../utils/mockData';
...
export default function Booking() {
  ...
  const services = [
    { id: 'catering', name: 'Premium Catering', price: 500 },
    { id: 'decoration', name: 'Event Decoration', price: 300 },
    { id: 'photography', name: 'Photography Package', price: 800 },
    { id: 'sound', name: 'Sound System', price: 200 },
  ];
