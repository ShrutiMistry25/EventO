...
export default function AddVenue() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newVenue: Venue = {
      ...
      isApproved: true, // Immediately visible to booking users
      createdAt: new Date().toISOString(),
    };

    addVenue(newVenue);
    toast.success('Venue added successfully! Now visible to customers.');
              ...
              <div className="space-y-2">
                ...
                <div className="input-with-icon">
                  ...
                  <input
                    ...
                    className="w-full pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                  />
                </div>
              </div>
