...
export default function DashboardLayout({ children, role }: DashboardLayoutProps) {
  ...
  useEffect(() => {
    // This will cause the component to re-render when route changes
  }, [location.pathname]);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Sidebar - hidden for admin role */}
      {role !== 'admin' && (
        <aside
          className={`fixed top-0 left-0 z-50 h-full w-64 bg-white shadow-xl transform transition-transform duration-300 pointer-events-auto border-r border-gray-200 ${
      ...
      {/* Main Content */}
      <div className={role === 'admin' ? '' : 'lg:pl-64'}>
        {/* Top Bar */}
        <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
          <div className="flex items-center justify-between px-4 py-4">
            ...
            <div className="lg:hidden">
              <h1 className="text-lg font-semibold text-gray-900">VenueBook</h1>
            </div>
